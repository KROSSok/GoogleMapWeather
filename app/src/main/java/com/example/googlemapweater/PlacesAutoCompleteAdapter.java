...
public class PlacesAutoCompleteAdapter extends ArrayAdapter<AutocompletePrediction> implements Filterable {
    ...
    public PlacesAutoCompleteAdapter (Context context, PlacesClient placesClient, AutocompleteSessionToken token) {
    ...
    private List<AutocompletePrediction> getAutoComplete(final CharSequence constraint){
        ...
        placesClient.findAutocompletePredictions(request).addOnSuccessListener(new OnSuccessListener<FindAutocompletePredictionsResponse>() {
            ...
            public void onSuccess(FindAutocompletePredictionsResponse response) {
                for (AutocompletePrediction prediction : response.getAutocompletePredictions()) {
                    ...
                    Log.e(TAG, "Place found for searching: " + constraint);
                }
            ...
            public void onFailure(@NonNull Exception exception) {
                if (exception instanceof ApiException) {
                    ...
                    Log.e(TAG, "Place not found: " + apiException.getStatusCode() + " " + constraint);
                }
            }
        });
        return tempResult;
